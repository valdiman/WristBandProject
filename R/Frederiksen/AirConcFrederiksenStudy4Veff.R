...
# Read data ---------------------------------------------------------------
{
  ...
  vol2 <- read.csv("Output/Data/Frederiksen/Volunteer2_PCBiVeff.csv",
                   row.names = NULL)
  # Data created in AirConcFrederiksenVeff.R
  fred <- read.csv("Output/Data/Frederiksen/Frederiksen_PCBiVeff.csv",
                   row.names = NULL)
}
...
# Save plot in folder
ggsave("Output/Plots/Frederiksen/FrederiksenVol2PCBiVeff.png",
