...
# Read data ---------------------------------------------------------------
{
  data.Fred.mass <- read.csv("Data/IRO/12_FrederiksenWBMass2022.csv",
                             check.names = FALSE)
  data.Fred.conc <- read.csv("Data/IRO/13_FrederiksenConc2022.csv",
                             check.names = FALSE)
...
# Save plot in folder
ggsave("Output/Plots/Frederiksen/FrederiksenHomeVeff.png", plot = plotfred,
       width = 7, height = 7, dpi = 500)

# Export data
write.csv(plot_data,
          file = "Output/Data/Frederiksen/Frederiksen_PCBiVeff.csv")
...
# Save plot in folder
ggsave("Output/Plots/Frederiksen/Frederiksen7dVeff.png", plot = plotfred.2,
       width = 7, height = 7, dpi = 500)

# Export data
write.csv(plot_data.2,
          file = "Output/Data/Frederiksen/Frederiksen_PCBiV3.csv")
