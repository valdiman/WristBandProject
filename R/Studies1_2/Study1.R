...
# Export
write.csv(WBMatrix, file = "Output/Data/Studies1_2/Study1/WDLinearity.csv")
...
# Export
write.csv(SR.st.1, file = "Output/Data/Studies1_2/Study1/WDSamplingRateStatV1.csv")
...
#export
write.csv(SR.st.2, file = "Output/Data/Studies1_2/Study1/WDSamplingRateStatV2.csv")
...
# Export
write.csv(SR.rot, file = "Output/Data/Studies1_2/Study1/WDSamplingRateRotV1.csv")
...
plot.18.30 <- ggplot(combined_data, aes(x = time, y = PCB18.30_comb,
  ...
  annotate("text", x = 1, y = 5.5,
           label = paste0("'Dynamic' == ",
                          round(slopes$slope[slopes$group == "Dynamic"], 2),
                          " ~ '(m'^3*'/d)'"), parse = TRUE, hjust = 0, size = 10,
           color = "black") +
  annotate("text", x = 1, y = 5.0,
           label = paste0("'Static' == ",
                          round(slopes$slope[slopes$group == "Static"], 2),
                          " ~ '(m'^3*'/d)'"), parse = TRUE, hjust = 0, size = 10,
           color = "black") +
  theme_bw() +
  xlim(0, 125) +
...
# Save plot
ggsave("Output/Plots/Studies1_2/Study1/PCB18.30SamplingRates.png",
...
plot.52 <- plot.52 +
  # Dynamic point
  annotate("point", x = 1, y = 6, shape = 21, size = 6,
           fill = group_colors["Dynamic"], color = "black") +
  annotate("text", x = 5, y = 6,
           label = paste0("'Dynamic' == ",
                          round(slopes$slope[slopes$group == "Dynamic"], 2),
                          " ~ '(m'^3*'/d)'"), parse = TRUE, hjust = 0,
           size = 10, color = "black") +
  # Static point
  annotate("point", x = 1, y = 5.5, shape = 21, size = 6,
  ...
  annotate("text", x = 5, y = 5.5,
           ...
           size = 10, color = "black") +
  # Study label
  annotate("text", x = 90, y = 0.1, label = "Study 1", hjust = 0,
           size = 10, color = "black") +
  # Panel label
  annotate("text", x = Inf, y = Inf, label = "(a)", hjust = 1.1,
           vjust = 1.5, size = 10, color = "black")

# See plot
plot.52

# Save plot
ggsave("Output/Plots/Studies1_2/Study1/PCB52SamplingRates.png",
...
# Save plot
ggsave("Output/Plots/Studies1_2/Study1/PCB118SamplingRates.png",
...
# Save plot
ggsave("Output/Plots/Studies1_2/Study1/PCB187SamplingRates.png",
...
# Save plot in folder
ggsave("Output/Plots/Studies1_2/Study1/Stat1_logKoa.png", plot = p.sr.stat.1.koa,
...
# Save plot in folder
ggsave("Output/Plots/Studies1_2/Study1/Stat2_logKoa.png", plot = p.sr.stat.2.koa,
       width = 6, height = 6, dpi = 500)
...
# Save plot in folder
ggsave("Output/Plots/Studies1_2/Study1/Rot_logKoa.png", plot = p.sr.rot.koa,
       width = 6, height = 6, dpi = 500)
